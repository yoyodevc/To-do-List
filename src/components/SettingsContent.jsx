...
const SettingsContent = () => {
  ...
  return (
    <main className="flex-1 overflow-y-auto bg-white pl-64" style={{ backgroundColor: '#ffffff' }}>
      <div className="p-6 ml-[5%] mr-[8%]">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="relative inline-flex h-6 w-11 items-center rounded-full bg-gray-100 cursor-not-allowed">
              <span className="inline-block h-4 w-4 rounded-full bg-gray-300 transform transition-transform" style={{transform: isToggled ? 'translateX(1.5rem)' : 'translateX(0.25rem)'}}/>
