    ...
    <div className="flex flex-col gap-4 mb-6">
      <div className="flex flex-col sm:flex-row sm:justify-between gap-3">
        <div className="flex flex-wrap justify-center sm:justify-normal gap-2 w-full sm:w-auto">
          ...
          <button onClick={() => setActiveFilter("active")} className={`flex-1 sm:flex-auto px-3 py-2 text-sm rounded-md ${activeFilter === "active" ? "bg-gray-100 font-bold" : "font-semibold hover:bg-gray-100"}`}>Active ({activeCount})</button>
          <button onClick={() => setActiveFilter("completed")} className={`flex-1 sm:flex-auto px-3 py-2 text-sm rounded-md ${activeFilter === "completed" ? "bg-gray-100 font-bold" : "font-semibold hover:bg-gray-100" }`}>Completed ({completedCount})</button>
        </div>
        <div className="flex flex-wrap justify-center sm:justify-normal gap-3 gap-x-4 w-full sm:w-auto pr-3">
          ...
          <div className="relative w-full max-w-[162px]">
            <select onChange={(e) => setSortOrder(e.target.value)} value={sortOrder} className="w-full pl-4 pr-8 py-2 text-sm font-semibold bg-gray-50 border border-gray-300 rounded-md appearance-none focus:ring-2 focus:ring-gray-500 focus:outline-none">
                    ...
                    <td className="px-3 sm:px-5 py-3">
                      <div className="flex flex-col space-y-1">
                        <div className="text-xs sm:text-sm text-gray-500">
                          ...
                          {new Date(task.dueDate).toLocaleTimeString('en-US', {hour: "numeric", minute: "2-digit",})}</div>
                        <div className="mt-1">
                          <span
                            className={`inline-flex items-center justify-center text-xs leading-4 font-semibold rounded-full px-2 py-0.5 w-34 ${task.category === "work"
                ...
                <tr>
                  <td colSpan="4" className="py-20 text-center">
                    <div className="flex flex-col items-center justify-center mt-10">
                      ...
                      <p className="mt-6 text-lg font-semibold text-gray-800">You're all set!</p>
                      <p className="text-sm text-gray-500 mt-2">No tasks remaining in this category.</p>
                    </div>
                  </td>
                </tr>
              )}
